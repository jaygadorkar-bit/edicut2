    ...
    <section className="px-5 py-20 sm:px-6 lg:py-24">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          <div>
            <p className="text-sm font-black uppercase tracking-[0.18em] text-primary">Creator feedback</p>
            <h2 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Less edit stress. More publishing momentum.</h2>
          </div>
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-gray-200 bg-secondary p-5">
              <p className="text-3xl font-black">50M+</p>
              <p className="mt-1 text-xs font-black uppercase tracking-wide text-muted-foreground">Views edited for</p>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-secondary p-5">
              <p className="text-3xl font-black">96%</p>
              <p className="mt-1 text-xs font-black uppercase tracking-wide text-muted-foreground">On-time delivery</p>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-secondary p-5">
              <p className="text-3xl font-black">3.2x</p>
              <p className="mt-1 text-xs font-black uppercase tracking-wide text-muted-foreground">Clip output lift</p>
            </div>
          </div>
        </div>
