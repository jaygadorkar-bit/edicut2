  ...
  return (
    <PageShell active="About">
      <section className="px-5 pb-16 pt-32 text-center sm:px-6">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-[#FF0000]">Creator-first post production</p>
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#717171]">YouTube-native pacing, retention-focused editing, and review workflows built to reduce bottlenecks.</p>
      </section>
      <section className="bg-[#F9F9F9] px-5 py-20 sm:px-6">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-5 text-lg leading-8 text-[#717171]">We combine editors, project managers, motion designers, and thumbnail support into one reliable post-production lane.</p>
        </div>
